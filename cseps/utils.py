...
def header(title: str):
    width = 56
    print()
    print(f"{Color.BOLD}{Color.BLUE}{'=' * (width + 2)}{Color.RESET}")
    print(f"{Color.BOLD}{Color.BLUE}  {title:^{width}}{Color.RESET}")
    print(f"{Color.BOLD}{Color.BLUE}{'=' * (width + 2)}{Color.RESET}")
    print()


def section(title: str):
    print(f"\n{Color.BOLD}{Color.MAGENTA}-- {title} {'-' * (48 - len(title))} --{Color.RESET}\n")
